function K = wind_trapezoidal(x,y,z,directions_scaled)
...
%plot3(x, y, z, 'ro', 'MarkerSize', 10, 'MarkerFaceColor', 'r','HandleVisibility','off'); % Center point of smaller circle
...
% ylabel('Y');
% zlabel('Z');
% title('Trapezoidal Cylinder Aligned with Direction Vector');
% grid on;
% axis equal;
% view(3);
% hold off;